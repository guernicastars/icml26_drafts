...
\input{sections/03_curriculum_fit.tex}
\input{sections/04_failure_modes.tex}
\input{sections/05_cross_domain.tex}
\input{sections/06_final_checkpoints.tex}
\input{sections/07_discussion.tex}
\input{sections/08_extended_v2.tex}
\input{sections/09_extended_v3.tex}
\input{sections/10_cross_theory.tex}
\input{sections/11_extended_v5.tex}
